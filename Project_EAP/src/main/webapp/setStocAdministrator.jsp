...
<br><br><br><br><br>
<form action="/administrator_f2" method="post" style="margin-top: 10px;
            margin-left: 25px;
            width: 290px;
            border: 1px solid white;
...
">
    ...
    <div class="container">
        ...
        <input type="text" id="stoc" placeholder="Stoc nou" name="stoc" required>
        ...
        <button type="submit" style="width: 250px;">Set stoc</button>
    </div>
</form>
