...
<form action="/home_creare_vnz" method="post" style="border-top-right-radius: 5px;
    ...
    <div class="container"style="padding-bottom: 0px;">
        ...
        <datalist id="magazin">
            ...
            <%
                if (request.getAttribute("listMagazine") != null) {
                    String listMagazine = (String) request.getAttribute("listMagazine");
                    for (int i = 0; i < listMagazine.split("&").length; i++) {
                        String op = listMagazine.split("&")[i];
                        out.print("<option value='" + op + "'>");
                    }
...
<form action="/vanzator" method="get" style="margin-top: 0px; border-top: 0px;
