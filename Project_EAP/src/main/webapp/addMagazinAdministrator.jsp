...
<br><br><br><br><br>
<form action="/administrator_f7" method="post" style="margin-top: 10px;
            margin-left: 25px;
            width: 290px;
            border: 1px solid white;
...
">
    ...
    <div class="container">
        <label for="magazin_id">ID Magazin</label>
        <input type="text" id="magazin_id" placeholder="ID" name="magazin_id" required>
        <label for="nume">Nume magazin</label>
        ...
        <button type="submit" style="width: 250px;">Adaugare magazin</button>
    </div>
</form>
